...
(
    ...
    recUpdatedAt timestamp not null default current_timestamp on update current_timestamp,
    createdAt timestamp not null default current_timestamp,
    CONSTRAINT fk_matches_tours_id
...
insert ignore into mydb.news (title, description, tourId, matchId) values ('Mi wins by 5 runs', 'some description', null, 2);
insert ignore into mydb.news (title, description, tourId, matchId) values ('IPL Auction 2024', 'some description', 1, null);
insert ignore into mydb.news (title, description, tourId, matchId) values ('IPL starts 22 March', 'some description', 1, null);
insert ignore into mydb.news (title, description, tourId, matchId) values ('IND win by 6 wickets against WI', 'some description', null, 8);
insert ignore into mydb.news (title, description, tourId, matchId) values ('IND squad against WI', 'some description', 3, null);
